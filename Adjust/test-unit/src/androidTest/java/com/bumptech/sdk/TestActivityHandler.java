...
public class TestActivityHandler {
    ...
    protected com.bumptech.sdk.test.UnitTestActivity activity;
    protected Context context;
    protected AssertUtil assertUtil;

    @Rule
    public ActivityTestRule<com.bumptech.sdk.test.UnitTestActivity> mActivityRule = new ActivityTestRule(com.bumptech.sdk.test.UnitTestActivity.class);
    ...
    public void testChecks() {
        ...
        assertUtil.info("Skipping initialization in background process (com.bumptech.sdk.test.test)");
        ...
        configCorrectProcess.setProcessName("com.bumptech.sdk.test.test");
